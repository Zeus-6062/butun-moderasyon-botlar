...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        let channel = client.guilds.cache.get(client.config.guildID).channels.cache.find(c => c.name === "819975015939178526") //log kanalının ismi
        ...
        message.guild.members.ban(member.id, { reason: `Yetkili: ${message.author} || Sebep ${reason} || Antiperes}` })
