...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        let channel = client.guilds.cache.get(client.config.guildID).channels.cache.find(c => c.name === "819978474386882600")
        ...
        moment.locale('tr')
        if (!member) return message.channel.send(embed.setDescription("Kullanıcı bulunamadı eya etiketlenmedi!"))
